    ...
    return (
      <div className="landingpage">
        <section className="image-landingpage">
          <div>
            <h1 className="landing-create">
              Create a Website For Your Music Project
            </h1>
            <p className="landing-explore">
              Explore the platform that gives you the ability to create, design,
              manage, and develop your own website.
            </p>
          </div>
